...
public class CleanCacheActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void formatMemory(long memory) {
        ...
        if (memory>900){
            ...
            memoryStr = cacheMemoryStr.substring(cacheMemoryStr.length()-1,cacheMemoryStr.length());
        }
    ...
    private void  initView(){
        ...
        animation = (AnimationDrawable)findViewById(R.id.tv_cleancache_memory).getBackground();
        animation.setOneShot(false);
        animation.start();
        mMemoryTV = (TextView)findViewById(R.id.tv_cleancache_memory);
        mMemoryUnitTV = (TextView)findViewById(R.id.tv_cleancache_memory);
